	...
	return (
		<div className="absolute flex flex-col bottom-[50px] transition-all duration-300 delay-300 px-[1rem] md:spx-[3rem] lg:px-[5.5rem] ">
			<h4
				...
				className="z-10 text-white text-center xs:text-start hover:cursor-pointer hover:opacity-60 transition-opacity duration-300 ease-in-out  text-[2rem] lg:text-[3rem] font-semibold mb-5"
			>
				{e.original_title}
			</h4>
