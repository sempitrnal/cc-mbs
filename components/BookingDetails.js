	...
	return (
		<div className="border rounded-xl w-[80%] mx-auto flex justify-between overflow-hidden mb-10">
			<div className="p-5">
				...
				<p className="text-xs text-gray-400 translate-y-1">Movie</p>
				<h2 className="mb-5 text-3xl">{movie.title}</h2>

				<div className="flex flex-col h-full gap-5 md:gap-20 md:flex-row">
					<div className="">
						<p className="text-xs text-gray-400 translate-y-1">Cinema</p>
						<h2 className="text-xl">Cinema {selectedCinema}</h2>
					</div>
					<div className="">
						<p className="text-xs text-gray-400 translate-y-1">Date</p>
					...
					<div className="">
						<p className="text-xs text-gray-400 translate-y-1">Time</p>
						<h2 className="text-xl">{selectedTime}</h2>
					</div>
				</div>
			</div>
